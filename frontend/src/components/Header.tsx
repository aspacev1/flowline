  ...
  return (
    <header className={`sidebar${collapsed ? " sidebar--collapsed" : ""}`}>
      ...
      <nav className="sidebar__nav">
        ...
        {/* Портфель — свой пункт, а не второе имя «Проектов»: два экрана с
            одинаковой подписью различить снаружи было нечем. */}
...
/* Значки нарисованы здесь, а не взяты библиотекой: их шесть, каждый — восемь
...
/* Портфель буквально: ручка и замок. Соседний значок раздела «Проекты» — тоже
   прямоугольник, и второй прямоугольник рядом с ним читался бы как та же
   страница; ручка сверху видна и в шестнадцати пикселях. */
function IconCards() {
  return (
    <Icon>
