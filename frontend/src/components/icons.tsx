...
/* Щит: панель владельца установки — про надзор за всей установкой, а не про
   настройку одного места работы, и шестерёнка соседних «Настроек» здесь
   повторила бы уже занятый ею смысл. */
