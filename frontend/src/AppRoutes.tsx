  ...
  return (
    <Routes>
      ...
      <Route element={<RequireAuth />}>
        ...
        {/* Панель владельца установки — не вкладка настроек: настройки
            правят рабочее пространство одной организации, а здесь список
            регистраций всей установки, за которым может смотреть и человек
            вовсе без организации на этом экране. Доступ решает не
            RequireAuth и не роль — сервер отвечает 403 всякому, чей адрес не
            назван в ADMIN_EMAILS, а экран показывает этот отказ тем же
            баннером, что и любой другой закрытый маршрут. */}
