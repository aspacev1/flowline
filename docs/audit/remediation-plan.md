# Flowline — план исправлений по итогам аудита
...
- [ ] **1.5** 🟠 **M** — Откат пачки: принимать `reason`; корректно
...
- [ ] **1.6** 🟠 **M** — Реордер: хранить в журнале минимальный дифф вместо
  снимка всех задач проекта.
  `backend/app/mutations.py:741-775`
- [ ] **1.7** 🟠 **S** — Порог отклонения: разделить `Δstart` и `Δduration` в
...
- [ ] **4.1** 🟡 **S** — Индексы: `dependencies.project_id`/`to_task_id`,
